...
btn-language = زبان
btn-title-language = زبان عنوان‌ها
...
desc-auto-translate-titles = عنوان ویدیوها رو به زبان تو ترجمه می‌کنم! 🌍
...
pick-title-language = زبان عنوان‌ها رو انتخاب کن!
language-changed = عالی! حالا به *{ $language }* صحبت می‌کنم!
language-updated = زبان به‌روز شد!
title-language-changed = حالا عنوان‌ها به *{ $language }* خواهند بود!
title-language-updated = زبان عنوان‌ها به‌روز شد!
